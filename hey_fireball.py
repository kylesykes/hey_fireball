...
def handle_command(fireball_message):
    ...
    if fireball_message.command == 'give':
        ...
        if setting:
            msg = f"I will start sending PM's to {fireball_message.requestor_name}."
        else:
            msg = f"I will stop sending PM's to {fireball_message.requestor_name}."
        send_message_to = fireball_message.requestor_id_only

#    elif fireball_message.command == 'setpm':
#        if get_pm_preference(fireball_message.requestor_id) == 1:
#            set_pm_preference(fireball_message.requestor_id, 0)
#            msg = f'I will no longer send PM\'s to {fireball_message.requestor_name}.'
#            send_message_to = fireball_message.requestor_id_only
#        else:
#            set_pm_preference(fireball_message.requestor_id, 1)
#            msg = f'I will start sending PM\'s to {fireball_message.requestor_name}'
#            send_message_to = fireball_message.requestor_id_only
